                      ...
                      child: Row(
                        children: [
                          Expanded(
                            child: Row(
                              children: [
                                SvgPicture.asset('assets/icons/search.svg',color: textGrey3,),
                          ...
                          GestureDetector(
                            onTap: scan,
                            child: SvgPicture.asset('assets/icons/scan.svg',color: textGrey3,),
                          )
                        ],
                      ),
                    ),
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 15,),
                const MainCategory(),
                const HorizontalProducts(text: 'Arzanladyşlar',),
                const SizedBox(height: 15,),
                const HorizontalProducts(text: 'Täzeler',),
                const SizedBox(height: 15,),
                ...
                const SizedBox(height: 15,),
                const HorizontalProducts(text: 'Lukmançylyk hajatly önümler',),
