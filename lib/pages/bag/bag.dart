                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Column(
                          children:
                              List.generate(cartProductList.length, (index) {
                            var splitted = cartProductList[index]['price']
                                .toString()
                                .split(' ');
            ...
            Positioned(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                        blurRadius: 5, color: Colors.black.withOpacity(0.05)),
                  ],
